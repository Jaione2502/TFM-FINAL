  ...
  <div class="menu-container">
    ...
    <form class="menu-form" @submit.prevent="guardarInventario">
      <div>
        ...
        <select id="usuario" v-model="usuario_id" required :disabled="loading">
      ...
      <div>
        ...
        <select id="ingrediente" v-model="ingrediente_id" required :disabled="loading">
...
// Util para “aplanar” distintas formas de respuesta
function normalizeList(res, keyFallback) {
  // Si ya es array
  if (Array.isArray(res)) return res;
  // Axios suele devolver { data: ... }
  if (res?.data) {
    if (Array.isArray(res.data)) return res.data;
    // Paginado tipo Laravel Resource { data: [...] }
    if (Array.isArray(res.data.data)) return res.data.data;
  }
  // Otras formas { ingredientes: [...] } o { usuarios: [...] }
...
async function guardarInventario() {
  ...
  try {
    ...
    // Mensaje flexible según forma de respuesta
    const msg =
      res?.message ||
      res?.data?.message ||
