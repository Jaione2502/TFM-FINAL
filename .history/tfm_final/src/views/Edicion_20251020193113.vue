    ...
    <form @submit.prevent="guardar">
      ...
      <template v-if="tipo === 'menus'">
       ...
       <template v-if="tipo === 'inventario'">
          ...
          <div>
            <select v-model.number="form.ingrediente_id">
              <option value="">Seleccionar Ingrediente</option>
              <option v-for="ing in listaIngredientes" :key="ing.id" :value="ing.id">
...
const form = reactive({
  ...
  ingrediente_id: route.query.ingrediente_id ? Number(route.query.ingrediente_id) : "",
  ...
  try {
    ...
    if (tipo.value === "categorias") {
      ...
      data = await actualizarItem("menus", id.value, { 
        ...
        if (form.ingrediente_id !== "" && !Number.isNaN(Number(form.ingrediente_id))) {
        payload.ingrediente_id = Number(form.ingrediente_id);
        }
