...
async function guardar() {
  try {
    ...
    if (tipo === "categorias") 
      {
        data = await actualizarItem("categoria", id, { 
          nombre: nombre.value, 
          descripcion: descripcion.value 
        });
      }
    else if (tipo === "perfiles")  {
       data = await actualizarItem("usuario", id, { 
          name: nombre.value, 
          email: email.value 
        });
      }
    else if (tipo === "comentarios")  {
       data = await actualizarItem("comentario", id, { 
       ...
       data = await actualizarItem("ingrediente", id, { 
          nombre: nombre.value, 
          descripcion: descripcion.value,
       ...
       data = await actualizarItem("menu", id, { 
          nombre: nombre.value, 
          fecha: fecha.value 
        });
